...
output:
  xaringan::moon_reader:
    css: [default, "../my_css/edi-colours.css", "../my_css/hygge-edi.css", "../my_css/edi-fonts.css"]
    lib_dir: libs
    nature:
...
.content-box-blue[If you want to generate a table], make sure it is in the HTML format (instead of Markdown or other formats), e.g.,
