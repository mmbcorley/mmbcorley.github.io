...
.content-box-red[add audio]
<!-- use mp3 audio, see code below -->
<br>
<audio src="img/good_times.mp3" controls></audio>
...
# Fox Tree (2001)
<br>
- listeners faster to indentify words after *uh*, but not *um*, in Dutch .right[.small[(Fox Tree, 2001)]]
...
<br/><br/>
.content-box-blue[**prediction** (next); **deception/pragmatics** (later)]
---
class: edi-softblue, center, middle, animated, bounceInDown
